...
class DocumentController extends Controller
{
    public function download(Request $req)
    {
        ...
        if($type=="image/jpeg"||$type=="image/png" || $type=="image/jpg")
       {
        ...
        {
             return view('general.supportingDocument.view',['notes'=>$notes,'docid'=>$docid,'docname'=>$docname,'docinfo'=>$docinfo,'show'=>$show]); 
    ...
    public function upload(Request $request)
    {
        ...
        $customMessages = [
            'mimes'=>'Wrong Document Type',
            'max' => 'Maximum Document Size',
            
        ];
        $validator = Validator::make(Input::all(),array( 'pdf.*' => 'mimes:pdf,jpeg,jpg,png|max:2000' ),$customMessages);
        ...
        $content = $this->sendRequest('Document','POST', 'common/upload',$docrepo);
