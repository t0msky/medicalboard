         ...
         <div id="accordion2" role="tablist" class="accordion" >
            ...
            <div class="card m-b-0">
               ...
               <div id="collapseRecommendation" class="collapse" role="tabpanel" aria-labelledby="headingRecommendation">
                  <div class="card-body">
                     @include('scheme.noticeDeath.newClaim.SAO.general.recommendation')
                  </div>
               </div>
            </div>
            <!-- Wages Info -->
            <div class="card m-b-0">
               ...
               <div id="collapseWages" class="collapse" role="tabpanel" aria-labelledby="headingWages">
                  <div class="card-body">
                     @include('scheme.noticeDeath.newClaim.SAO.sbk.wages')
                  </div>
               </div>
            </div>
            <!-- HUS Info -->
            <div class="card m-b-0">
               ...
               <div id="collapseHus" class="collapse" role="tabpanel" aria-labelledby="headingHus">
                  <div class="card-body">
                     @include('scheme.noticeDeath.newClaim.SAO.sbk.hus_info')
                  </div>
               </div>
            </div>
            <!-- FPM Recommendation -->
            <div class="card m-b-0">
               ...
               <div id="collapseFpmRec" class="collapse" role="tabpanel" aria-labelledby="headingFpmRec">
                  <div class="card-body">
                     @include('scheme.noticeDeath.newClaim.SAO.sbk.fpm_recommendation')
                  </div>
               </div>
            </div>
         </div>
