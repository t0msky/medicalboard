        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="p-20">
                        <form action="#">
                            <h5 class="card-title">@lang('scheme/similar.title')</h5>
                                <hr>
                                <div class="row p-t-20">
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                            <label class="control-label">@lang('scheme/similar.attr.name')</label>
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label">@lang('scheme/similar.attr.similar_startdate')</label>
                                                <input type="date" name="similar_startdate" id="similar_startdate" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label">@lang('scheme/similar.attr.similar_enddate')</label>
                            ...
                            <div class="row">
                                ...
                                <div class="form-actions">
                                    <button type="button" class="btn btn waves-effect waves-light btn-info" id="btnreset" onclick="submitform()">@lang('scheme/noticetype.reset')</button>
                                </div>
                            </div>
                        </div>
                            <div class="row">
                                <div class="col-md-12">
                                <div class="form-actions">
                                    <button type="button" class="btn btn waves-effect waves-light btn-info">ADD REMARKS</button>
                                </div>
                            </div>
                        </div>
                        <div class='row'>
