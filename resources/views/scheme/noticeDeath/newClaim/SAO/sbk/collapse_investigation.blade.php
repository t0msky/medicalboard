         ...
         <div id="accordion2" role="tablist" class="accordion" >
            ...
            <div class="card m-b-0">
               ...
               <div id="collapseInconsistency" class="collapse" role="tabpanel" aria-labelledby="headingInconsistency">
                  <div class="card-body">
                     @include('scheme.noticeDeath.newClaim.general.inconsistency')
                  </div>
               </div>
            </div>
            <!-- Appointment -->
            <div class="card m-b-0">
               ...
               <div id="collapseAppointment" class="collapse" role="tabpanel" aria-labelledby="headingAppointment">
                  <div class="card-body">
                     @include('scheme.noticeDeath.newClaim.general.appointment')
                  </div>
               </div>
            </div>
            ...
            <div class="card m-b-0">
               ...
               <div id="collapseInvDocs" class="collapse" role="tabpanel" aria-labelledby="headingInvDocs">
                  <div class="card-body">
                     @include('scheme.noticeDeath.newClaim.general.investigation_doc')
                  </div>
               </div>
            </div>
         </div>
