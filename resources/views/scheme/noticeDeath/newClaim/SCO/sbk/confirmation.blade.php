    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                <form action="/Scheme/confirmation_death" method="POST">    
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-actions">
                                ...
                                <a href="/Scheme/deathscosbkpreview" id='preview' type="button" name="action" value="Preview" class="btn btn-secondary">@lang('scheme/confirmation.preview')</a>
