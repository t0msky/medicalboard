...
<div class="card-body p-b-0">
    ...
    <ul class="nav nav-tabs" role="tablist" id="tabMenu">
        ...
        <li class="nav-item-recommendations-sbk"> <a class="nav-link" data-toggle="tab" href="#recommendations_sbk" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">@lang('form/scheme.general.tab_title.recommendation_sbk')</span></a> </li>
        <li class="nav-item-recommendations-spi"> <a class="nav-link" data-toggle="tab" href="#recommendations_spi" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">@lang('form/scheme.general.tab_title.recommendation_spi')</span></a> </li>
    ...
    <div class="tab-content tabcontent-border">
        ...
        <div class="tab-pane p-20 active" id="remarks" role="tabpanel">
            @include('scheme.noticeDeath.newClaim.general.collapse_remarks')
        </div>
            <!-- Claim Details tab -->
        <div class="tab-pane p-20" id="claim" role="tabpanel">
            @include('scheme.noticeDeath.newClaim.IO.sbk.collapse')
        </div>
            <!-- Investigation tab -->
        <div class="tab-pane p-20" id="investigation" role="tabpanel">
            @include('scheme.noticeDeath.newClaim.IO.sbk.collapse_investigation')
        </div>
            <!-- Query and Opinion tab -->
        <div class="tab-pane p-20" id="query" role="tabpanel">
            @include('scheme.noticeDeath.newClaim.general.query')
        </div>
            <!-- SBK Recommendation tab -->
        <div class="tab-pane p-20" id="recommendations_sbk" role="tabpanel">
            @include('scheme.noticeDeath.newClaim.IO.sbk.collapse_rec')
        </div>
            <!-- SPI Recommendation tab -->
        <div class="tab-pane p-20" id="recommendations_spi" role="tabpanel">
            @include('scheme.noticeDeath.newClaim.IO.spi.collapse_rec')
        </div>
        ...
        <div class="tab-pane p-20" id="upload" role="tabpanel">
            @include('scheme.noticeDeath.newClaim.IO.sbk.collapse_upload')
        </div>
    </div>
</div>
