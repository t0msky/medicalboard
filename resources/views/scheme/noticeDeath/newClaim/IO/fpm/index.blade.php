...
<div class="card-body p-b-0">
    ...
    <div class="tab-content tabcontent-border">
        ...
        <div class="tab-pane p-20" id="claim" role="tabpanel">
            @include('scheme.noticeDeath.newClaim.IO.fpm.collapse')
        </div>
        ...
        <div class="tab-pane p-20" id="recommendations" role="tabpanel">
            @include('scheme.noticeDeath.newClaim.IO.fpm.collapse_rec')
        </div>
            <!-- Supporting Document tab -->
        <div class="tab-pane p-20" id="upload" role="tabpanel">
            @include('scheme.noticeDeath.newClaim.IO.fpm.collapse_upload')
        </div>
    </div>
</div>
