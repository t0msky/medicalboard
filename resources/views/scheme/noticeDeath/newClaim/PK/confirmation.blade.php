                                    ...
                                    <table id="tableClaimant" class="display nowrap table table-hover table-striped table-bordered" cellspacing="40" width="50%">
                                        ...
                                        <tbody class='align-middle'>
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>
                                                    <input type="date" id="stampdate" name="stampdate" value="" class="form-control">
                                                </td>
                                                <td></td>
                                            </tr>
                                        </tbody>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-actions">
                                ...
                                <button type="submit" name="action" value="Submit" class="btn waves-effect waves-light btn-primary" id="submit" onclick="return confirm('Are you sure want to submit?');">@lang('button.submit')</button>
                                <button type="submit" name="action"  value="Preview" class="btn waves-effect waves-light btn-secondary" >@lang('button.preview')</button>

                                @else
                            
                                <button type="submit" name="action" value="Submit" class="btn waves-effect waves-light btn-primary" id="submit" disabled>@lang('button.submit')</button>
                                <button type="submit" name="action"  value="Preview" class="btn waves-effect waves-light btn-secondary" >@lang('button.preview')</button>
                            
                                @endif

                                <button type="submit" name="action" value="Save" class="btn waves-effect waves-light btn-success">@lang('button.save')</button>
                            </div>
                        </div>
                    </div>  
                </form>
