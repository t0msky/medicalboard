...
{{-- <div class="col-md-12"><br> --}}
	<div class="card-body p-b-0">
		...
		<ul class="nav nav-tabs" role="tablist">
			...
			<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#claimDetails" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">@lang('Case Information')</span></a> </li>
			<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#inconsistency" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Inconsistent & Doubtful Information</span></a> </li>
			<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#medical_board" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">@lang('Medical Board Decision')</span></a> </li>
		...
		<div class="tab-content">
			...
			<div class="tab-pane p-20" id="claimDetails" role="tabpanel">
				@include('scheme.HUK.SCO.afterMB.collapse')
			</div>
			<div class="tab-pane p-20" id="inconsistency" role="tabpanel">
				@include('scheme.HUK.SCO.beforeMB.collapse_inconsistency')
			</div>
			<div class="tab-pane p-20" id="medical_board" role="tabpanel">
				@include('scheme.HUK.SCO.afterMB.mbDecision')
			</div>
			<div class="tab-pane p-20" id="query_opinion" role="tabpanel">
				@include('scheme.noticeAccident.newClaim.SCO.query_opinion')
			</div>
			<div class="tab-pane p-20" id="recommend" role="tabpanel">
				@include('scheme.HUK.SCO.beforeMB.recommendation')
			</div>
			<div class="tab-pane p-20" id="uploadDocuments_SCO" role="tabpanel">
				{{-- @include('scheme.noticeAccident.newClaim.SCO.collapse_upload') --}}
			</div>
		</div>
	</div>
{{-- </div> --}}
