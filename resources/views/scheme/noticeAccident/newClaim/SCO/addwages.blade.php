            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-20">
                        <form action="#">
                            <div class="form-body">
                            <h5 class="card-title">@lang('Additional Wages Information')</h5>
                            <hr>
                            <div class="row p-t-20"> 
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">@lang('Employer Code')</label>
                                        <input type="text" name="" id="similar_empcode" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="" id="similar_empname" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row p-t-20">
                                                ...
                                                <table id="demo-foo-row-toggler" class="table table-bordered"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style='width:15%' class="text-center">@lang('Wages (RM)')</th>
                                                            <th style='width:15%' class="text-center">@lang('Contribution Paid (RM)')</th>
                                                            <th style='width:15%' class="text-center">@lang('Contribution Payable (RM)')</th>
                                                            {{-- <th style='width:15%' class="text-center">@lang('wages.attr.contribution')</th> --}}
                                                            <th style='width:15%' class="text-center">@lang('Contribution Surplus / Deficit (RM)')</th>
