        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="p-20">
                        <form action="#">
                            <h5 class="card-title">Similar Worker Information</h5>
                                <hr>
                                <div class="row p-t-20">
                                    <div class="col-md-12">
                                        <div class="form-group"><br>
                                            <button class="btn btn-facebook waves-effect waves-light" id="similar_search" type="button"> Search </button>
                                        </div>
                                    </div>
                                </div>
                                <div id="similar_section" style="display:none">
                                    <div class="row p-t-20">
                                        <div class="col-md-4">
