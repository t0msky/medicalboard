        ...
        <div class="card">
            <div class="card-body">
                <form action="#">
                    ...
                    <div class="similar_work" id="similar_work" style="display:none">
                        @include('scheme.noticeAccident.newClaim.SCO.similar')
                    </div>
                    <div class="additional_wages" id="additional_wages" style="display:none">
                        @include('scheme.noticeAccident.newClaim.SCO.addwages')
                    </div>
                </div>
                </form>
            </div>
