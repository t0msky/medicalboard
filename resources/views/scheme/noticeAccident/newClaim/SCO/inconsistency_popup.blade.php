            ...
            <div class="card-body">
                <div class="p-20">
                    <form action="#">
                        <div class="row">
                            <div class="col-md-12">
                                <h3>@lang('form/scheme.general.collapse.inconsistent.title')</h3>
                                <hr>
                                ...
                                <div  class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label">@lang('form/scheme.general.collapse.inconsistent.findings')</label>
                                                <textarea rows="3" type="text" id="findings" name="findings" class="form-control" ></textarea>
                                        </div>
                                    </div>
                                </div>
                                {{-- <div class="col-md-4">
                        ...
                        {{-- <div class="row">
                            <div class="col-md-12">
                                <h3>@lang('scheme/index.attr.statement')</h3>
                                <hr>
                                <div class="row p-t-20"> 
                                    <div class="col-md-12">  
                                        <label class="control-label">Statement 12c</label>
                                    </div>
                                </div>
                                <div class="table-responsive" id="table-generated">
                                    <table  id="table-medical-details0" class="table table-sm table-bordered" data-toggle-column="first">
                                        ...
                                        <tbody>
                                            <tr data-expanded="true" class="workrow" id="tr0_0">
                                                ...
                                                <td>
                                                    <div class="col-md-12">
                                                        <input type="text" name="ICNO" value="" class="form-control" >
                                                    </div>
                                                </td>
                                                <td>
                                                    <div>
                                    ...
                                    <div class="row p-t-20"> 
                                    <div class="col-md-12">  
                                        <label class="control-label">Doubtful</label> 
                        ...
                        {{-- <div class="row">
                            <div class="col-md-12">
                                <h3>@lang('scheme/index.attr.upload_documents')</h3>
                                <hr>
                            </div>
                            <div class="col-md-12">
                        ...
                        {{-- <div class="row">
                            <div class="col-md-12">
                                <h3>@lang('scheme/index.attr.opinion')</h3>
                                <hr>
                            </div>
                        </div> --}}
                    </form>
