                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">{{-- <label class="control-label">@lang('inconsistency.attr.medicalleave')</label> --}}
                                <table class="table table-sm table-bordered" data-toggle-column="first" id="table_inconsistent">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style='width:15%'>@lang('form/scheme.general.collapse.inconsistency.noticedetails')</th> 
                                            <th style='width:10%'>@lang('form/scheme.general.collapse.inconsistency.supportDoc')</th>
                                            <th style='width:10%'>@lang('form/scheme.general.collapse.inconsistency.correcData')</th>
                                            ...
                                            <th style='width:5%'>@lang('form/scheme.general.collapse.inconsistency.action')</th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody>
                                        <tr data-expanded="true" class="inconsistencyrow" id="ic1">
                                            ...
                                            <td>
                                                <button type="button"  class="btn btn-sm btn-danger btn_del_inconsistency1" id="del_consistency1"><i class="fas fa-trash-alt fa-sm"></i></button>
                                ...
                                <div class="form-actions">
                                    <button type="button" id="btn_add_inconsistency" value='' class="btn btn-sm waves-effect waves-light btn-info">@lang('button.add_item')</button>
                                </div>    
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header  card-title">
                <h4 class="modal-title" id="exampleModalLabel3">@lang('form/scheme.general.collapse.inconsistency.title')</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                @include('scheme.noticeAccident.newClaim.IO.inconsistency_popup') 
            </div>
