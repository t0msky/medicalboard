                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table id="table_appointment" class="table table-bordered"
                                        ...
                                        <thead>
                                        <tr>
                                            <th style='width:8%'>@lang('form/scheme.general.collapse.appointment.investigate_date')</th>
                                            <th style='width:8%'>@lang('form/scheme.general.collapse.appointment.investigate_time')</th>
                                            <th style='width:8%'>@lang('form/scheme.general.collapse.appointment.location')</th>
                                            <th style='width:8%'>Attendees</th>
                                            {{-- <th style='width:8%'>@lang('form/scheme.general.collapse.appointment.name')</th> --}}
                                            <th style='width:8%'>@lang('form/scheme.general.collapse.appointment.action')</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                ...
                                <div class="modal-dialog modal-xl" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            @include('scheme.noticeAccident.newClaim.IO.appointment_popup') 
                                        </div>
                             ...
                             <div class="modal fade" id="reshedule_popup" tabindex="-1" role="dialog" aria-labelledby="reshedulePopup">
                                <div class="modal-dialog modal-xl" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            @include('scheme.noticeAccident.newClaim.IO.reshedule_popup') 
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">@lang('button.close')</button>
                                            <button type="submit" class="btn btn-primary">@lang('button.save')</button>
                        ...
                        <div class='row'>
                            <div class="col-md-12">
                                <div class="form-actions">
                                    ...
                                    <button type="button" class="btn btn waves-effect waves-light btn-secondary">@lang('button.clear')</button-->
