                                ...
                                <div id="accordion2" role="tablist" class="accordion" >
                                        ...
                                        <div class="card m-b-0">
                                                <div class="card-header" role="tab" id="headingZero0">
                                                        <h5 class="mb-0">                           
                                                                <a class="link" data-toggle="collapse" data-parent="#accordion2" href="#collapseZero0" aria-expanded="false" aria-controls="collapseZero0"><h6 class="card-title"><i class="fa fa-plus"></i> @lang('form/scheme.general.collapse.preparer.title')</h6>
                                                        </a>
                                                        </h5>
                                                </div>
                                                <div id="collapseZero0" class="collapse" role="tabpanel" aria-labelledby="headingZero0">
                                                        <div class="card-body">@include('scheme.general.prepare')</div>
                                                </div>
                                        </div>
                                        <!-- CASE INFO -->
                                        <div class="card m-b-0">
                                                <div class="card-header" role="tab" id="headingOne1">
                                                        <h5 class="mb-0">                           
                                                                <a class="link" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne1" aria-expanded="false" aria-controls="collapseOne1"><h6 class="card-title"><i class="fa fa-plus"></i> @lang('form/scheme.general.collapse.case_info.title')</h6>
                                                        </a>
                                                        </h5>
                                                </div>
                                        ...
                                        <div class="card m-b-0">
                                                ...
                                                <div id="collapseSix5" class="collapse" role="tabpanel" aria-labelledby="headingSix5">
