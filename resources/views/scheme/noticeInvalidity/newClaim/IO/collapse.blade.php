<div id="accordion2" role="tablist" class="accordion">
        ...
        <div class="card m-b-0">
            <div class="card-header" role="tab" id="invalidityInfo">
                <h5 class="mb-0">
                    <a class="link" data-toggle="collapse" data-parent="#accordion2" href="#ii"
        ...
        <div class="card m-b-0">
            <div class="card-header" role="tab" id="prefferedSocso">
                <h5 class="mb-0">
                    <a class="link" data-toggle="collapse" data-parent="#accordion2" href="#ps" aria-expanded="false" aria-controls="collapseOne1">
                        <h6 class="card-title"><i class="fa fa-plus"></i> 
        ...
        <div class="card m-b-0">
            <div class="card-header" role="tab" id="confirmation">
                <h5 class="mb-0">
                    <a class="link" data-toggle="collapse" data-parent="#accordion2" href="#cob"
                        aria-expanded="false" aria-controls="collapseOne1">
                        <h6 class="card-title"><i class="fa fa-plus"></i>
