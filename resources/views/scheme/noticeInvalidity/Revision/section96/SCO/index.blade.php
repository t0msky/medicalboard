        ...
        <div class="card-body">
            ...
            <div class="tab-content tabcontent-border">
                <div class="tab-pane p-20 active" id="remarks" role="tabpanel">
                    @include('Scheme.noticeInvalidity.Revision.section96.SCO.remarks')
                </div>
                <div class="tab-pane p-20" id="collapse" role="tabpanel">
                    @include('Scheme.noticeInvalidity.Revision.section96.SCO.collapse')
                </div>
                <div class="tab-pane p-20" id="recommend" role="tabpanel">
                    @include('Scheme.noticeInvalidity.Revision.section96.SCO.suggestion')
                </div>
