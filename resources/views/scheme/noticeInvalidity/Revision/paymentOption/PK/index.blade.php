    ...
    <div class="col-md-12">
        <div class="card-body">
            ...
            <ul class="nav customtab" role="tablist" id="tabMenu">
                ...
                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#claimDetails" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">@lang('Claim Details')</span></a></li>
                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#supportingDocument" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">@lang('Supporting Document')</span></a> </li>
            </ul>
            ...
            <div class="tab-content tabcontent-border">
                <div class="tab-pane p-20 active" id="remarks" role="tabpanel">
                    @include('scheme.noticeInvalidity.Revision.paymentOption.PK.remarks')
                </div>
                    ...
                    <div id="accordion2" role="tablist" class="accordion">
                        ...
                        <div class="card m-b-0">
                            ...
                            <div id="applicantInfo" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                                <div class="card-body">
                                    @include('scheme.noticeInvalidity.Revision.paymentOption.PK.applicant_info')
                                </div>
                                <div id="applicantInfo" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                                    <div class="card-body">
                                        @include('Scheme.noticeInvalidity.Revision.paymentOption.PK.applicant_info')
                        ...
                        <div class="card m-b-0">
                            ...
                            <div id="insuredPerson" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                                <div class="card-body">
                                    @include('scheme.noticeInvalidity.Revision.paymentOption.PK.ob_info')
                                </div>
                                <div id="insuredPerson" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                                    <div class="card-body">
                                        @include('Scheme.noticeInvalidity.Revision.paymentOption.PK.ob_info')
                        ...
                        <div class="card m-b-0">
                            ...
                            <div id="paymentOption" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                                <div class="card-body">
                                    @include('scheme.noticeInvalidity.Revision.paymentOption.PK.payment_option')
                                </div>
                                <div id="paymentOption" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                                    <div class="card-body">
                                        @include('Scheme.noticeInvalidity.Revision.paymentOption.PK.payment_option')
