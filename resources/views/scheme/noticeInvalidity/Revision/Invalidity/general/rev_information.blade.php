                    ...
                    <div class="card m-b-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row p-t-20">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">@lang('Scheme Revision Ref No')</label>
                                        <input type="text" id="schemeRevisionRefNo" name="schemeRevisionRefNo" value="" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">@lang('Revision Registration Date')</label>
                                        <input type="text" id="revisionReisterationDate" name="revisionReisterationDate" value="" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row p-t-20">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="revisionNotice" name="revisionNotice" value="" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
