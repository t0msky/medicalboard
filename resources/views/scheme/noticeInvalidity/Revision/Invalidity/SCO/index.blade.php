...
<div class="row">
    <div class="col-md-12">
        <div class="card-body">
            <h3 class="card-title">@lang('Revision Invalidity')</h3>
            ...
            <ul class="nav nav-tabs" role="tablist" id="tabMenu">
                ...
                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#rev" role="tab"><span
                            class="hidden-sm-up"><i class="ti-home"></i></span> <span
                            class="hidden-xs-down">@lang('Revision Information')</span></a>
                </li>

                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#doubtful" role="tab"><span
                            class="hidden-sm-up"><i class="ti-home"></i></span> <span
                            class="hidden-xs-down">@lang('Inconsistent and Doubtful Information')</span></a>
                </li>

                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#qANDo" role="tab"><span
                            class="hidden-sm-up"><i class="ti-home"></i></span> <span
                            class="hidden-xs-down">@lang('Query and Opinion')</span></a>
                </li>

                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#recommend" role="tab"><span
                            class="hidden-sm-up"><i class="ti-home"></i></span> <span
                            class="hidden-xs-down">@lang('Recommendation')</span></a>
                </li>
            ...
            <div class="tab-content tabcontent-border">
                ...
                <div class="tab-pane p-20" id="rev" role="tabpanel">
                    @include('scheme.noticeInvalidity.Revision.invalidity.general.collapse_revisionInformation')
                </div>
                <div class="tab-pane p-20" id="doubtful" role="tabpanel">
               
                </div>
                <div class="tab-pane p-20" id="qANDo" role="tabpanel">
                    {{-- @include('scheme.noticeInvalidity.Revision.invalidity.SCO.recommendBefore.recommend') --}}
                </div>
