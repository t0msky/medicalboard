      ...
      <div class="modal-content">
         ...
         <form action="#" method="POST" id="reset">
            ...
            <div class="form-body">                   
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6">
                           <div class="custom-control custom-radio">
                              <input type="radio" id="car_majikan_utama" name="car_majikan" class="custom-control-input">
                              <label class="custom-control-label" for="car_majikan_utama">Majikan Utama</label>
                           </div>
                           <div class="custom-control custom-radio">
                              <input type="radio" id="car_majikan_langsung" name="car_majikan" class="custom-control-input">
                              <label class="custom-control-label" for="car_majikan_langsung">Majikan Langsung</label>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="form-row">
                  <div class="form-group col-md-12 col-lg-12">
                        <div class="form-group">
                           ...
                           <input type="text" name="empadd1" id="empadd1" value="" class="form-control clearFields" >
                        </div>
                  </div>
                  <div class="form-group col-md-12 col-lg-12">
                     <div class="form-group">
                        <input type="text" name="empadd2" id="empadd2" value="" class="form-control clearFields" >
                     </div>
                  </div>
                  <div class="form-group col-md-12 col-lg-12">
                     <div class="form-group">
                        <input type="text" name="empadd3" id="empadd3" value="" class="form-control clearFields" >
                     </div>
                  </div>
               </div>
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <select class="form-control clearFields" name="state1" required >
                              ...
                              @foreach($ref_table->state as $soweird)
                              <option value="{{$soweird->ref_code}}">{{$soweird->desc_en}}</option>
                              @endforeach
                           </select>
                        </div>
                     </div>
               ...
               <div class="form-row">
                     <div class="form-group col-md-12 col-lg-12">
                        <div class="form-group">
                           ...
                           <input type="text" name="add1" id="add1" value="" class="form-control clearFields" >
                        </div>
                     </div>
                     <div class="form-group col-md-12 col-lg-12">
                        <div class="form-group">
                           
                           <input type="text" name="add2" id="add2" value="" class="form-control clearFields" >
                        </div>
                     </div>
                     <div class="form-group col-md-12 col-lg-12">
                        <div class="form-group">
                           
                           <input type="text" name="add3" id="add3" value="" class="form-control clearFields" >
                        </div>
                     </div>
               </div>
               <div class='form-row'>
               ...
               <div class="form-row" id="jenis_lain" style="display:none">
                  <div class="form-group col-md-12 col-lg-8">
                     <div class="form-group">
                        <label class="control-label">Lain-lain</label>
                        <textarea type="text" name="jenislain" id="jenislain" form-rows="6" class="form-control jenis_lain"></textarea>
                     </div>
                  </div>
               </div>
               <div class='form-row'>
               ...
               <div class="form-row" id="taraf_lain" style="display:none">
                  <div class="form-group col-md-12 col-lg-8">
                     <div class="form-group">
                        <label class="control-label">Lain-lain</label>
                        <textarea type="text" name="taraflain" id="taraflain" form-rows="6" class="form-control taraf_lain"></textarea>
                     </div>
                  </div>
               </div>
               ...
               <!-- ================================ QUESTION 1 - YA ==================================== -->
               <div class="form-row" id="ques1_ya" style="display: none">
                  <div class="form-group col-md-12 col-lg-10">
                     <div class="form-group">
                        <div class="col-sm-12">
                           <div class="custom-control custom-radio">
               ...
               <!-- ================================ QUESTION 1 (YA) - TETAP ==================================== -->
               <div class="form-row" id="ques1_tetaps" style="display: none">
                  <div class="form-group col-md-12 col-lg-4">
                     <div class="form-group">
               ...
               <div class="form-row" id="ques1_lain" style="display: none">
               ...
               <!-- ================================ QUESTION 1 - TIDAK ==================================== -->
               <div class="form-row" id="ques1_tidak" style="display: none">
                  <div class="col-md-7 m-b-10">
                     <label class="control-label">Lain-lain</label>
                     <textarea class="form-control form-control-lg" id="" placeholder="" style="height: 100px;"></textarea>
                  </div>
               ...
               <!-- ================================ QUESTION 2 - YA ==================================== -->
               <div class="form-row" id="ques2_ya" style="display: none">
                  <div class="col-md-4">
                     <div class="form-group">
                        <label class="control-label">Dari Jam</label>
                        <input type="text" id="name" name="name" value="" class="form-control" required>    
               ...
               <!-- ================================ QUESTION 2 - TIDAK ==================================== -->
               <div class="form-row" id="ques2_tidak" style="display: none">
                  <div class="col-md-7 m-b-10">
                     <label class="control-label">Lain-lain</label>
                     <textarea class="form-control form-control-lg" id="" placeholder="" style="height: 100px;"></textarea>
                  </div>
               ...
               <!-- ================================ QUESTION 3 - YA ==================================== -->
               <div class="form-row" id="ques3_ya" style="display: none">
                  <div class="col-md-10">
                     <div class="form-group">
               ...
               <div class="form-row" id="ques3_ya_lain" style="display: none">
                  <div class="col-md-7 m-b-10">
                     <label class="control-label">Lain-lain</label>
                     <textarea class="form-control form-control-lg" id="" placeholder="" style="height: 100px;"></textarea>
                  </div>
               ...
               <!-- ================================ QUESTION 3 - TIDAK ==================================== -->
               <div class="form-row" id="ques3_tidak" style="display: none">
                  <div class="col-md-7 m-b-10">
                     <label class="control-label">Lain-lain</label>
                     <textarea class="form-control form-control-lg" id="" placeholder="" style="height: 100px;"></textarea>
                  </div>
               ...
               <!-- ================================ QUESTION 4 - YA ==================================== -->
               <div class="form-row" id="ques4_ya" style="display: none">
                  <div class="col-md-10">
                     <div class="form-group">
               ...
               <div class="form-row" id="ques4_ya_lain" style="display: none">
                  <div class="col-md-7 m-b-10">
                     <label class="control-label">Lain-lain</label>
                     <textarea class="form-control form-control-lg" id="" placeholder="" style="height: 100px;"></textarea>
                  </div>
               ...
               <!-- ================================ QUESTION 4 - TIDAK ==================================== -->
               <div class="form-row" id="ques4_tidak" style="display: none">
                  <div class="col-md-7 m-b-10">
                     <label class="control-label">Lain-lain</label>
                     <textarea class="form-control form-control-lg" id="" placeholder="" style="height: 100px;"></textarea>
                  </div>
               ...
               <!-- ================================ QUESTION 5 - YA ==================================== -->
               <div class="form-row" id="ques5_ya" style="display: none">
                  <div class="col-md-10">
                     <div class="form-group">
                        <div class="col-sm-12">
                           <div class="custom-control custom-radio">
               ...
               <div class="form-row" id="ques5_ya_lain" style="display: none">
                  <div class="col-md-7 m-b-10">
                     <label class="control-label">Lain-lain</label>
                     <textarea class="form-control form-control-lg" id="" placeholder="" style="height: 100px;"></textarea>
                  </div>
               ...
               <!-- ================================ QUESTION 5 - TIDAK ==================================== -->
               <div class="form-row" id="ques5_tidak" style="display: none">
                  <div class="col-md-7 m-b-10">
                     <label class="control-label">Lain-lain</label>
                     <textarea class="form-control form-control-lg" id="" placeholder="" style="height: 100px;"></textarea>
                  </div>
               ...
               <!-- =================================== QUESTION 6 - YA ======================================= -->                                                
               <div class="form-row" id="ques6_ya" style="display: none">
                  <div class="col-md-10">
                     <div class="form-group">
               ...
               <div class="form-row" id="ques6_ya_lain" style="display: none">
                  <div class="col-md-7 m-b-10">
                     <label class="control-label">Lain-lain</label>
                     <textarea class="form-control form-control-lg" id="" placeholder="" style="height: 100px;"></textarea>
                  </div>
               ...
               <!-- ================================ QUESTION 6 - TIDAK ==================================== -->
               <div class="form-row" id="ques6_tidak" style="display: none">
                  <div class="col-md-7 m-b-10">
                     <label class="control-label">Lain-lain</label>
                     <textarea class="form-control form-control-lg" id="" placeholder="" style="height: 100px;"></textarea>
                  </div>
               ...
               <div class="form-row" id="ques7_lain" style="display: none">
                  <div class="col-md-7 m-b-10">
                     <label class="control-label">Lain-lain</label>
                     <textarea class="form-control form-control-lg" id="" placeholder="" style="height: 100px;"></textarea>
                  </div>
               ...
               <div class="form-row" id="ques8_lain" style="display: none">
                  <div class="col-md-7 m-b-10">
                     <label class="control-label">Lain-lain</label>
                     <textarea class="form-control form-control-lg" id="" placeholder="" style="height: 100px;"></textarea>
                  </div>
               ...
               <!-- =================================== QUESTION 9 - YA ======================================= -->                                                
               <div class="form-row" id="ques9_ya" style="display: none">
                  <div class="col-md-10">
                     <div class="form-group">
               ...
               <div class="form-row" id="ques9_ya_lain" style="display: none">
                  <div class="col-md-7 m-b-10">
                     <label class="control-label">Lain-lain</label>
                     <textarea class="form-control form-control-lg" id="" placeholder="" style="height: 100px;"></textarea>
                  </div>
               ...
               <!-- ================================ QUESTION 9 - TIDAK ==================================== -->
               <div class="form-row" id="ques9_tidak" style="display: none">
                  <div class="col-md-7 m-b-10">
                     <label class="control-label">Lain-lain</label>
                     <textarea class="form-control form-control-lg" id="" placeholder="" style="height: 100px;"></textarea>
                  </div>
               ...
               <!-- ================================ QUESTION 10 - YA ==================================== -->
               <div class="form-row" id="ques10_ya" style="display: none">
                  <div class="col-md-7 m-b-10">
               ...
               <div class="form-row" id="ques11_lain" style="display: none">
                  <div class="col-md-7 m-b-10">
                     <label class="control-label">Lain-lain</label>
                     <textarea class="form-control form-control-lg" id="" placeholder="" style="height: 100px;"></textarea>
                  </div>
               ...
               <div class="form-row" id="ques12_lain" style="display: none">
                  <div class="col-md-7 m-b-10">
                     <label class="control-label">Lain-lain</label>
                     <textarea class="form-control form-control-lg" id="" placeholder="" style="height: 100px;"></textarea>
                  </div>
               ...
               <div class="form-row" id="ques13_lain" style="display: none">
                  <div class="col-md-7 m-b-10">
                     <label class="control-label">Lain-lain</label>
                     <textarea class="form-control form-control-lg" id="" placeholder="" style="height: 100px;"></textarea>
                  </div>
               ...
               <!-- =================================== QUESTION 22 - YA ======================================= -->                                                
               <div class="form-row" id="ques22_ya" style="display: none">
                  <div class="col-md-10">
                     <div class="form-group">
                        <div class="col-sm-6">
                           <div class="custom-control custom-radio">
               ...
               <div class="form-row" id="ques22_ya_lain" style="display: none">
                  <div class="col-md-7 m-b-10">
                     <label class="control-label">Lain-lain</label>
                     <textarea class="form-control form-control-lg" id="" placeholder="" style="height: 100px;"></textarea>
                  </div>
               ...
               <!-- ================================ QUESTION 22 - TIDAK ==================================== -->
               <div class="form-row" id="ques22_tidak" style="display: none">
                  <div class="col-md-7 m-b-10">
                     <label class="control-label">Lain-lain</label>
                     <textarea class="form-control form-control-lg" id="" placeholder="" style="height: 100px;"></textarea>
                  </div>
               ...
               <div class="form-row">
                  <div class="col-md-10">
                     <div class="form-group">
                        ...
                        <div class="col-sm-8">
                           <div class="custom-control custom-radio">
                              <input type="radio" id="car_ulasan1" name="car_ulasan" class="custom-control-input">
                              <label class="custom-control-label" for="car_ulasan1">Pekerja</label>
                           </div>
                           <div class="custom-control custom-radio">
                              <input type="radio" id="car_ulasan2" name="car_ulasan" class="custom-control-input">
                              <label class="custom-control-label" for="car_ulasan2">Bukan Pekerja</label>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="form-row">
                  <div class="col-md-8">
                     <div class="form-group">
                        ...
                        <textarea type="text" name="ulasanpengesyoran" id="ulasanpengesyoran" form-rows="6" class="form-control lain"></textarea>
                     </div>
                  </div>
               </div>
               ...
               <div class="form-row">
                  <div class="col-md-10">
                     <div class="form-group">
                        ...
                        <div class="col-sm-6">
                           <div class="custom-control custom-radio">
                              <input type="radio" id="car_result1" name="car_result" class="custom-control-input">
                              <label class="custom-control-label" for="car_result1">Pekerja</label>
                           </div>
                           <div class="custom-control custom-radio">
                              <input type="radio" id="car_result2" name="car_result" class="custom-control-input">
                              <label class="custom-control-label" for="car_result2">Bukan pekerja</label>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="form-row">
                  <div class="col-md-8">
                     <div class="form-group">
                        <label class="control-label">Jika ada ulasan sila nyatakan</label>
                        <textarea type="text" name="ulasankeputusan" id="ulasankeputusan" form-rows="6" class="form-control lain"></textarea>
                     </div>
                  </div>
               </div>
            </div>
