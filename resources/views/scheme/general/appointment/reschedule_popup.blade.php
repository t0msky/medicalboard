    ...
    <div class="form-group col-md-12 col-lg-4">
        <div class="form-group">
            ...
            <select class="form-control clearFields" name="category_type">
                ...
                <option selected hidden readonly value="please select">@lang('scheme/noticetype.attr.please_select')
                </option>
    ...
    <div class="form-group col-md-12 col-lg-4">
        <div class="form-group">
            ...
            <select class="form-control clearFields" name="state1" required>
                ...
                {{--@if(!empty($empinfo) && $empinfo->state_code == $s->ref_code--)}}
        ...
        <div class="form-group">
            ...
            <div class="form-group col-md-12 col-lg-4">
                <div class="custom-control custom-radio">
                    <input type="radio" id="custom_Radio_Employer1" name="custom_Radio2"
                        onClick="others_attendes_list1()" class="custom-control-input">
                    <label class="custom-control-label" for="custom_Radio_Employer1">Employer</label>
                </div>
            </div>
            <div class="form-group col-md-12 col-lg-4">
                <div class="custom-control custom-radio">
                    <input type="radio" id="custom_Radio_insured_person1" name="custom_Radio2"
                        onClick="others_attendes_list1()" class="custom-control-input"
                        onclick="recommendationview_no3()">
                    <label class="custom-control-label" for="custom_Radio_insured_person1">Insured Person</label>
                </div>
            </div>
            <div class="form-group col-md-12 col-lg-4">
                <div class="custom-control custom-radio">
                    <input type="radio" id="others_attendess1" name="custom_Radio2" onClick="others_attendes_list1()"
                        class="custom-control-input" onclick="recommendationview_no3()">
...
<div class="row p-t-20">
    <div class="form-group col-md-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="form-group col-md-12 col-lg-4">
                <div class="custom-control custom-radio">
                    <input type="radio" id="custom_Radio_document11" name="custom_Radio" onClick="others_document1()"
            ...
            <div class="form-group col-md-12 col-lg-4">
                <div class="custom-control custom-radio">
                    <input type="radio" id="custom_Radio_document21" name="custom_Radio" onClick="others_document1()"
                        class="custom-control-input" onclick="recommendationview_no3()">
            ...
            <div class="form-group col-md-12 col-lg-4">
                <div class="custom-control custom-radio">
                    <input type="radio" id="document_others1" name="custom_Radio" onClick="others_document1()"
                        class="custom-control-input" onclick="recommendationview_no3()">
