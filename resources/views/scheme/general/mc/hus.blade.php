        ...
        <form method="POST" action="HUS">
            ...
            <div class="form-body ">
                ...
                <div class="col-md-12" id="container">
                    <div class="table-responsive" id="table-medical">
                        <div class="form-actions">
                            <button type="button" id="btn_add_mc0" value='0' class="btn btn-sm waves-effect waves-light btn-info">@lang('button.add_hus')</button>
                        </div>
                        
                        <table  id="table-medical-details0" class="table table-sm table-bordered" data-toggle-column="first">
                            <thead>
                                <tr>
                                    <th style='width:15%'>@lang('form/scheme.general.collapse.mc.type_hus')</th> 
                                    <th style='width:20%'>@lang('form/scheme.general.collapse.mc.nameAddress_clinic')</th> 
                                    <th style='width:8%'>@lang('form/scheme.general.collapse.mc.start_date')</th>
                                    <th style='width:8%'>@lang('form/scheme.general.collapse.mc.end_date')</th>
                                    <th style='width:10%'>@lang('form/scheme.general.collapse.mc.days_work')</th>
                                    <th style='width:8%'>@lang('form/scheme.general.collapse.mc.action')</th>
                                    {{-- <th style='width:20%'>@lang('form/scheme.general.collapse.mc.mc_recommendation')</th> --}}
                                    <th style='width:15%'>@lang('form/scheme.general.collapse.mc.hus_recommendation')</th>
                                </tr>
                            </thead>
                            ...
                            @if(!empty($husinfo->parent))
                                ...
                                <tr data-expanded="true" class="workrow" id="tr0_{{$key}}">
                                    ...
                                    <td>
                                        {{-- <a class='adddraft' id="add_attended_work0_{{$key}}" value='0_{{$key}}' data-toggle="button" data-more="#sh" aria-pressed="false"><i class="fas fa-plus" ></i></a>
                                        <a class='deletedraft btn_del_workmc' id="del_attended_work0_{{$key}}"><i class="fas fa-trash-alt "></i></a> --}}
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-4">
                        <div class="form-group">
                            <label class="control-label">@lang('form/scheme.general.collapse.mc.total_eligible')</label>
                            <input type="text" name="total_eligible" id="total_eligible" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-4">
                        <div class="form-group">
                            <label class="control-label">@lang('form/scheme.general.collapse.mc.total_hus')</label>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-4">
                        <div class="form-group">
                            <label>@lang('form/scheme.general.collapse.mc.wages_mc')</label><span class="required">*</span>
				...
				<div class="col-md-12">
					...
					<label for="minimal-checkbox-disabled-checked">@lang('form/scheme.general.collapse.mc.mc_exceed')</label>
				</div>
            </div>
