                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table id="demo-foo-row-toggler" class="table table-bordered" data-toggle-column="first">
                                                                ...
                                                                @foreach ($month as $m)
                                                                @if ($m->ref_code == $gaji->month)
                                                                <td><input type="text" value='{{$m->desc_en}}' class='form-control'readonly>
                                                ...
                                                <td>{{$cnt+1}}</td>
                                                    {{--<td>
                                                        ...
                                                        <select id="month[{{$contrcnt}}][{{$cnt}}]" name="month[{{$contrcnt}}][{{$cnt}}]" class="form-control" readonly>
                                                            @foreach ($month as $m)
                                                            @if ($m->ref_code == $accdmonth)
                                                            <option value='{{$m->ref_code}}' selected>{{$m->desc_en}}</option>
                                                            @else
                                                            <option value='{{$m->ref_code}}'>{{$m->desc_en}}</option>
                                                            @endif
                                                            @endforeach
                                                        </select>
                                                    </td>--}}
