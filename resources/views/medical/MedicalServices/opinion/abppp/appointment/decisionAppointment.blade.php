                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table" style="border-top:0px;">
                                                    <tr>
                                                        <td><label class="control-label">@lang('Committee Panel Name 1
                                                                :')</label>
                                                            <input type="text" value="" class="form-control" readonly>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><label class="control-label">@lang('Committee Panel Name 2
                                                                :')</label>
                                                            <input type="text" value="" class="form-control" readonly>
                                                        </td>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td><label class="control-label">@lang('Committee Panel Name 3
                                                                :')</label>
                                                            <input type="text" value="" class="form-control" readonly>
                                                        </td>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td> <label class="control-label">@lang('Chairman
                                                                Name/Replacement Chairman :')</label>
                                                    ...
                                                    <tr id="clari1">
                                                        ...
                                                        <td>
                                                            <div class="input-group-append">
                                                                ...
                                                                @include('medical.MedicalServices.noticeAccident.modal_document')
                                                            </div>
                                                            <p id="requestDoc1"></p>
                                                        </td>
