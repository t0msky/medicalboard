            ...
            <div class="card-body m-10">
                <form action="" method="">
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="appt_hospital" id="appt_hospital_session" required class="select2 form-control" style="width:100%;">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <span class="required">*</span>
                                    <input name="brief_date" id="brief_date" type="date" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <span class="required">*</span>
                                    <select name="brief_session" required class="form-control" required>
                                        <option value="">-- @lang('option.please_select') -- </option>}
                        ...
                        <table id="add-work_history " class="display table table-hover table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th width="15%">@lang('form/medical.secretariat.ip_details')</th>
                                    <th width="15%">@lang('form/medical.secretariat.icno')</th> 
                                    <th width="35%">@lang('form/medical.secretariat.panel_list')</th> 
                                    <th width="10%">@lang('form/medical.secretariat.status_case')</th>
                                    <th width="10%">@lang('form/medical.secretariat.result')</th>
                    ...
                    <div class="form-actions">
                        <button type="button" class="btn btn waves-effect waves-light btn-success" id="btnsetappt">End Session
                        </button>
                    </div>
                </form>
            </div>
