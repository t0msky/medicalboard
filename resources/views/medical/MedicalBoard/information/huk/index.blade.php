        ...
        <div class="card-body p-b-0">
            ...
            <div class="row p-12">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"> 
                        <a class="nav-link active" data-toggle="tab" href="#application_info_huk" role="tab" id="navbar_application_info_huk"><span class="hidden-sm-up"><i class="ti-user"></i></span><span class="hidden-xs-down">@lang('form/medical.tab_title.application_info')</span>
                        </a> 
                    </li>

                    <li class="nav-item"> 
                        <a class="nav-link" data-toggle="tab" href="#current_case_info_huk" role="tab" id="navbar_current_case_info_huk"><span class="hidden-sm-up"><i class="ti-pencil-alt"></i></span> <span class="hidden-xs-down">@lang('form/medical.tab_title.current_case_info')</span>
                        </a> 
                    </li>

                    <li class="nav-item"> 
                        <a class="nav-link" data-toggle="tab" href="#history_info_huk" role="tab" id="navbar_history_info_huk"><span class="hidden-sm-up"><i class="ti-layers"></i></span> <span class="hidden-xs-down">@lang('form/medical.tab_title.history')</span>
                        </a> 
                    </li>

                    <li class="nav-item"> 
                        <a class="nav-link" data-toggle="tab" href="#supporting_docs_huk" role="tab" id="navbar_supporting_docs_huk"><span class="hidden-sm-up"><i class="ti-layers-alt"></i></span> <span class="hidden-xs-down">@lang('form/medical.tab_title.supporting_doc')</span>
                        </a> 
                    </li>

                    <li class="nav-item"> 
                        <a class="nav-link" data-toggle="tab" href="#remarks_huk" role="tab"><span class="hidden-sm-up"><i class="ti-notepad"></i></span> <span class="hidden-xs-down">@lang('form/medical.tab_title.remarks')</span>
                        </a> 
                    </li>
                    
                    <li class="nav-item"> 
                        <a class="nav-link" data-toggle="tab" href="#decision_huk" role="tab" id="navbar_decision_huk"><span class="hidden-sm-up"><i class="ti-notepad"></i></span> <span class="hidden-xs-down">@lang('form/medical.tab_title.decision')</span>
                        </a> 
                    </li>

                    <li class="nav-item" id="feedback_tab"> 
                        <a class="nav-link" data-toggle="tab" href="#feedback_huk" role="tab" id="navbar_feedback_huk"><span class="hidden-sm-up"><i class="ti-notepad"></i></span> <span class="hidden-xs-down">@lang('form/medical.tab_title.feedback')</span>
                        </a> 
                    </li>

                    <li class="nav-item"> 
                        <a class="nav-link" data-toggle="tab" href="#appointment_huk" role="tab" id="navbar_appointment_huk"><span class="hidden-sm-up"><i class="ti-notepad"></i></span> <span class="hidden-xs-down">@lang('form/medical.tab_title.appointment')</span>
                        </a> 
                    </li> 
                    <li class="nav-item"> 
                ...
                <div class="tab-content tabcontent-border">
                    ...
                    <div class="tab-pane p-20" id="remarks_huk" role="tabpanel">
                        {{-- @include('medical.MedicalBoard.information.general.remarks') --}}
                        @include('general.remarks')
                    </div>

                    <div class="tab-pane p-20" id="decision_huk" role="tabpanel">
                        @include('medical.MedicalBoard.information.general.decision')
                    </div>

                    <div class="tab-pane p-20" id="feedback_huk" role="tabpanel">
                        @include('medical.MedicalBoard.information.general.feedback')
                    </div>

                    <div class="tab-pane p-20" id="appointment_huk" role="tabpanel">
                        ...
                        <div class="tab-pane p-20" id="preview_assessment" role="tabpanel">
                            @if(checkRole(['PNL']))
                                ...
                                @include('medical.MedicalBoard.information.huk.disclaimerHuk')
                             @else
...
<script>
    ...
    $("#btn_next_insured_person").click(function () {
        $("#current_case_info_huk").addClass("active");
        $("#application_info_huk").removeClass("active");
        $("#navbar_application_info_huk").removeClass("active");
        $("#navbar_current_case_info_huk").addClass("active");
    });

    $("#btn_next_current_case").click(function () {
        $("#history_info_huk").addClass("active");
        $("#current_case_info_huk").removeClass("active");
        $("#navbar_current_case_info_huk").removeClass("active");
        $("#navbar_history_info_huk").addClass("active");
    });

    $("#btn_next_history").click(function () {
        $("#supporting_docs_huk").addClass("active");
        $("#history_info_huk").removeClass("active");
        $("#navbar_history_info_huk").removeClass("active");
        $("#navbar_supporting_docs_huk").addClass("active");
    });

    $("#btn_next_support_docs").click(function () {
        $("#decision_huk").addClass("active");
        $("#supporting_docs_huk").removeClass("active");
        $("#navbar_supporting_docs_huk").removeClass("active");
        $("#navbar_decision_huk").addClass("active");
    });

    $("#btn_next_decision").click(function () {
        $("#appointment_huk").addClass("active");
        $("#decision_huk").removeClass("active");
        $("#navbar_decision_huk").removeClass("active");
        $("#navbar_appointment_huk").addClass("active");
    });
     ...
     $("#btn_submit_query").click(function () {
        $("#feedback_huk").addClass("active");
        $("#decision_huk").removeClass("active");
        $("#navbar_decision_huk").removeClass("active");
        $("#navbar_feedback_huk").addClass("active");
    });
...
<script>
    ...
    $("#addpanelbtn").on("click", function () {
        ...
        cols += '<td><button type="button" class="delpanelbtn btn btn-md btn-danger"><i class="fas fa-trash-alt"></i></button></td>';
        newRow.append(cols);
...
$('.cbox_decision').click(function(){
    // alert('yuhuhuh');
    var disctype = $('#decision_discipline').val();

    if(disctype == '1'){
        var $inputs = $('.cbox_decision')
        if($(this).is(':checked')){
