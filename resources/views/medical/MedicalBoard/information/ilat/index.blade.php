            ...
            <div class="card-body p-b-0">
                ...
                <div class="row p-12">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item"> 
                            <a class="nav-link active" data-toggle="tab" href="#application_info_ilat" role="tab" id="navbar_application_info_ilat">
                        ...
                        <li class="nav-item"> 
                            <a class="nav-link" data-toggle="tab" href="#current_case_info_ilat" role="tab" id="navbar_current_case_info_ilat"><span class="hidden-sm-up"><i class="ti-pencil-alt"></i></span> <span class="hidden-xs-down">@lang('form/medical.tab_title.current_case_info')</span>
                            </a> 
                        </li>

                        <li class="nav-item"> 
                            <a class="nav-link" data-toggle="tab" href="#history_info_ilat" role="tab" id="navbar_history_info_ilat"><span class="hidden-sm-up"><i class="ti-layers"></i></span> <span class="hidden-xs-down">@lang('form/medical.tab_title.history')</span>
                            </a> 
                        </li>

                        <li class="nav-item"> 
                            <a class="nav-link" data-toggle="tab" href="#supporting_docs_ilat" role="tab" id="navbar_supporting_docs_ilat"><span class="hidden-sm-up"><i class="ti-layers-alt"></i></span> <span class="hidden-xs-down">@lang('form/medical.tab_title.supporting_doc')</span>
                            </a> 
                        </li>

                        <li class="nav-item"> 
                            <a class="nav-link" data-toggle="tab" href="#remarks_ilat" role="tab"><span class="hidden-sm-up"><i class="ti-notepad"></i></span> <span class="hidden-xs-down">@lang('form/medical.tab_title.remarks')</span>
                            </a> 
                        </li>
                        
                        <li class="nav-item"> 
                            <a class="nav-link" data-toggle="tab" href="#decision_ilat" role="tab" id="navbar_decision_ilat"><span class="hidden-sm-up"><i class="ti-notepad"></i></span> <span class="hidden-xs-down">@lang('form/medical.tab_title.decision')</span>
                            </a> 
                        </li>

                        <li class="nav-item" id="feedback_tab"> 
                            <a class="nav-link" data-toggle="tab" href="#feedback_ilat" role="tab" id="navbar_feedback_ilat"><span class="hidden-sm-up"><i class="ti-notepad"></i></span> <span class="hidden-xs-down">@lang('form/medical.tab_title.feedback')</span>
                            </a> 
                        </li>

                        <li class="nav-item"> 
                            <a class="nav-link" data-toggle="tab" href="#appointment_ilat" role="tab" id="navbar_appointment_ilat"><span class="hidden-sm-up"><i class="ti-notepad"></i></span> <span class="hidden-xs-down">@lang('form/medical.tab_title.appointment')</span>
                            </a> 
                        </li> 
                        <li class="nav-item"> 
                    ...
                    <div class="tab-content tabcontent-border">
                        ...
                        <div class="tab-pane p-20" id="remarks_ilat" role="tabpanel">
                            {{-- @include('medical.medicalboard.information.general.remarks') --}}
                            @include('general.remarks')
                        </div>

                        <div class="tab-pane p-20" id="decision_ilat" role="tabpanel">
                            @include('medical.medicalboard.information.general.decision')
                        </div>

                        <div class="tab-pane p-20" id="feedback_ilat" role="tabpanel">
                            @include('medical.medicalboard.information.general.feedback')
                        </div>

                        <div class="tab-pane p-20" id="appointment_ilat" role="tabpanel">
                        ...
                        <div class="tab-pane p-20" id="preview_assessment" role="tabpanel">
                            @if(checkRole(['PNL']))
                                ...
                                @include('medical.medicalboard.information.ilat.disclaimerIlat')
...
<script>
    ...
    $("#btn_next_insured_person").click(function () {
        $("#current_case_info_ilat").addClass("active");
        $("#application_info_ilat").removeClass("active");
        $("#navbar_application_info_ilat").removeClass("active");
        $("#navbar_current_case_info_ilat").addClass("active");
    });

    $("#btn_next_current_case").click(function () {
        $("#history_info_ilat").addClass("active");
        $("#current_case_info_ilat").removeClass("active");
        $("#navbar_current_case_info_ilat").removeClass("active");
        $("#navbar_history_info_ilat").addClass("active");
    });

    $("#btn_next_history").click(function () {
        $("#supporting_docs_ilat").addClass("active");
        $("#history_info_ilat").removeClass("active");
        $("#navbar_history_info_ilat").removeClass("active");
        $("#navbar_supporting_docs_ilat").addClass("active");
    });

    $("#btn_next_support_docs").click(function () {
        $("#decision_ilat").addClass("active");
        $("#supporting_docs_ilat").removeClass("active");
        $("#navbar_supporting_docs_ilat").removeClass("active");
        $("#navbar_decision_ilat").addClass("active");
    });

    $("#btn_next_decision").click(function () {
        $("#appointment_ilat").addClass("active");
        $("#decision_ilat").removeClass("active");
        $("#navbar_decision_ilat").removeClass("active");
        $("#navbar_appointment_ilat").addClass("active");
    });
     ...
     $("#btn_submit_query").click(function () {
        $("#feedback_ilat").addClass("active");
        $("#decision_ilat").removeClass("active");
        $("#navbar_decision_ilat").removeClass("active");
        $("#navbar_feedback_ilat").addClass("active");
    });
