          ...
          <li></li>
            ...
            <li> <a class="has-arrow fcolor" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-grid2"></i><span class="hide-menu">@lang('navbar.medical_board')</span></a>
                <ul aria-expanded="false" class="collapse">
                        ...
                        <li> <a class="fcolor" href="{{Route('attendance')}}" >@lang('navbar.attendance') </a></li>
                        <li> <a class="fcolor" href="{{Route('secretariat')}}" >@lang('navbar.secretariat') </a></li>
                </ul>
            </li>

            <li> <a class=" fcolor" href="{{Route('assessment')}}" aria-expanded="false"><i class="ti-layout-grid2"></i><span class="hide-menu">@lang('navbar.assessment') </span></a></li>
            ...
            <li> <a class="has-arrow fcolor" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-grid2"></i><span class="hide-menu">@lang('navbar.decision')</span></a>
                <ul aria-expanded="false" class="collapse">
                        <li> <a class="fcolor" href="{{ route('huk_seksyen32') }}" >@lang('navbar.decision_huk')</a></li>
                        <li> <a class="fcolor" href="{{ route('tnc_ilat') }}" >@lang('navbar.decision_ilat') </a></li>
                        <li> <a class="fcolor" href="{{ route('decision_rayuan_huk') }}" >@lang('navbar.decision_rayuan_huk') </a></li>
                        <li> <a class="fcolor" href="{{ route('decision_rayuan_od') }}" >@lang('navbar.decision_rayuan_od') </a></li>
                </ul>
            </li>
            @endif 
