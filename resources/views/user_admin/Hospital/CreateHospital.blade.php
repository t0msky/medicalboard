	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				<div class="card-body">
					<div class="form-body">
						<h5 class="card-title">@lang('form/admin.general.hospital.title1')</h5>
						<hr>
						<form method="POST" action="{{route('create_hospital')}}">
							...
							<div class="form-row">
								<div class="form-group col-md-12 col-lg-12">
									...
									<input type="text" name="add1" class="form-control clearFields">
								</div>
								<div class="form-group col-md-12 col-lg-12">
									<input type="text" name="add2" class="form-control clearFields">
								</div>
								<div class="form-group col-md-12 col-lg-12">
									<input type="text" name="add3" class="form-control clearFields">
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-md-12 col-lg-4">
							...
							<div class="form-group col-md-12 col-lg-8">
								...
								<div class="row p-l-20">
									<div class="custom-control custom-checkbox">
										<input type="checkbox" value="1" name="jdind" class="custom-control-input" id="customCheck1">
										<label class="custom-control-label" for="customCheck1">@lang('form/admin.general.hospital.medical_board')</label>
									</div>

									<div class="custom-control custom-checkbox">
										<input type="checkbox" value="1" name="jdkind" class="custom-control-input" id="customCheck2">
										<label class="custom-control-label" for="customCheck2">@lang('form/admin.general.hospital.medical_special_board')</label>
									</div>

									<div class="custom-control custom-checkbox">
										<input type="checkbox" value="1" name="jdrind" class="custom-control-input" id="customCheck3">
